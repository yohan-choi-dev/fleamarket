...
function NotFoundPage() {
  return (
    <div className="NotFoundPage">
      <Navigation />
      <main className="NotFoundPage-main-section">
        <h1>
          Oops, page not found. Go back <Link to="/">home</Link>.
        </h1>
        <div className="bb8">
      ...
      <p className="NotFoundPage-animation-credit">
        BB8 Animation Credit:{' '}
        <a href="https://www.youtube.com/watch?v=QZdj42liTtU&t=212s">DevTips</a>
      </p>
      <Footer />
    </div>
  );
